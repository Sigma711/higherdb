...
impl BloomFilter {
    pub fn new(bits_per_key: usize) -> Self {
        // 0.69 =~ ln(2) and we intentionally round down to reduce probing cost
        // a little bit
...
impl FilterPolicy for BloomFilter {
    ...
    fn may_contain(&self, filter: &[u8], key: &[u8]) -> bool {
        ...
        // Use the encoded k so that we can read filters generated by bloom
    ...
    fn create_filter(&self, keys: &[Vec<u8>]) -> Vec<u8> {
        ...
        let mut dst: Vec<u8> = vec![0; bytes + 1]; // the extra place of the length
                                                   //bits
