...
///
/// A builtin cache implementation with a least-recently-used eviction policy is
/// provided.
/// Clients may use their own implementations if they want something more sophisticated.
/// (like scan-resistance, a custom eviction policy, variable cache sizing, etc.)
